 ...
 * @author PCUSER
 */
@WebServlet(name = "DestinationActivationServlet", urlPatterns = {"/DestinationActivationServlet"})
public class DestinationActivationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sqlInsert = "UPDATE destinations SET status=(?) where id=(?)";
